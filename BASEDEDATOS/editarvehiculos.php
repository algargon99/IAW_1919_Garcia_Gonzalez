  ...
  <body>
    <?php
      ...
      /* Consultas de selección que devuelven un conjunto de resultados */
        $query="SELECT * from vehiculos v join clientes c on c.codcliente=v.codcliente";
      ...
      <?php
          ...
          while($obj = $result->fetch_object()) {
              ...
              echo "<tr>";
                ...
                echo "<td><a href='actualizarvehiculos.php?cod=".$obj->Matricula."'>".$obj->Nombre." ".$obj->Apellidos."</a></td>";
              echo "</tr>";
          }
